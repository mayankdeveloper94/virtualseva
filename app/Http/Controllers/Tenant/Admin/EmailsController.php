...
class EmailsController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.emails.create',compact('departments','msgId','replyUser','subject','replyEmail'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(isset($requestData['all_members']) && $requestData['all_members']==1){
            ...
            if(isset($requestData['departments'])){
                ...
                foreach($requestData['departments'] as $value){
                    ...
                    $email->departments()->attach($value);
        ...
        return redirect('admin/emails')->with('flash_message', __('admin.message-sent'));
    }
   ...
   /* public function update(Request $request, $id)
    {
        ...
        return redirect('admin/emails')->with('flash_message', 'Email updated!');
    }*/
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/emails')->with('flash_message', __('admin.message').' '.__('admin.deleted'));
    }
...
// The PDF source is in original.pdf
    ...
    public function viewInbox(Email $email){
       ...
       return view('admin.emails.inbox_show', compact('email'));
    }
