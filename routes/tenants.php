...
Route::group(['middleware'=>['web','storage'],'namespace'=>'App\\Http\\Controllers\\Tenant\\'],function(){
	...
	Route::post('/leadformsubmit','Site\ReferralController@leadformsubmitNew')->name('site.leadformsubmit.new');
	
    //Route::get('/ref/{code}','Site\ReferralController@ref')->name('site.ref');
    Route::get('/thtindia/vasero/{code}','Site\ReferralController@ref')->name('site.ref');
	Route::get('/thtindia/vaseronew/{code}','Site\ReferralController@refnew')->name('site.refnew');
	Route::post('/thtindia/leadformsubmit/{code}','Site\ReferralController@leadformsubmit')->name('site.leadformsubmit');
    ...
    Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function(){
        ...
        Route::get('/kyc_verify','Admin\MembersController@kyc_verify')->name('admin.kyc_verify');
        Route::get('/kyc_verify_edit/{id}','Admin\MembersController@kyc_verify_edit')->name('admin.kyc_verify_edit');
        Route::patch('/kyc_verify_update/{id}','Admin\MembersController@kyc_verify_update')->name('admin.kyc_verify_update');
		...
		//Route::get('sociallinks','Admin\SettingsController@sociallinks')->name('settings.sociallinks');
		//Route::get('form','Admin\SettingsController@form')->name('settings.form');
		Route::resource('forms', 'Admin\FormsController');
		Route::resource('sociallinks', 'Admin\SociallinksController');
		Route::resource('herowidgets', 'Admin\HerowidgetsController');
		Route::get( "herowidgets/removeimage/{id}", "Admin\HerowidgetsController@removeimage" );
		
		Route::resource('carouselsliders', 'Admin\CarouselslidersController');
		Route::get( "carouselsliders/removeimage/{id}", "Admin\CarouselslidersController@removeimage" );
		
		Route::get( "options/{id}", "Admin\FormsController@options" );
		
		Route::get( "deleteoptions/{id}/{id1}", "Admin\FormsController@deleteoptions");
		Route::post( "deleteoptions/{id}/{id1}", "Admin\FormsController@deleteoptions");
		
		Route::get( "addoptions/{id}", "Admin\FormsController@addoptions");
		Route::post( "saveoptions/{id}", "Admin\FormsController@saveoptions");
		
		Route::get( "editoptions/{id}/{id1}", "Admin\FormsController@editoptions");
		Route::post( "saveeditoptions/{id}/{id1}", "Admin\FormsController@saveeditoptions");
        ...
        Route::resource('campaign', 'Admin\CampaignsController');
        Route::get("advertisements/{id}", "Admin\AdvertisementsController@show" )->name('admin.view-all');
        Route::get("advertisements/create/{id}", "Admin\AdvertisementsController@create" )->name('admin.create');
        
        Route::resource('advertisements', 'Admin\AdvertisementsController');
        Route::get("advertisements/removeimage/{id}", "Admin\AdvertisementsController@removeimage" );
        
        Route::get("campaign/{id}/channel-partners/create", "Admin\CampaignChannelPartnersController@create" )->name('ad.channer-parnters.create');
        Route::post("campaign/{id}/channel-partners/store", "Admin\CampaignChannelPartnersController@store" )->name('ad.channer-parnters.store');
        
        Route::get("advertisements/{advertisement:id}/channel-partners/create", "Admin\AdvertisementChannelPartnersController@create" )->name('ad.channer-parnters.create');
        Route::post("advertisements/{advertisement:id}/channel-partners/store", "Admin\AdvertisementChannelPartnersController@store" )->name('ad.channer-parnters.store');
        
        Route::get("earning", "Admin\CampaignsController@earning")->name('ad.campaign.earning');

        Route::get( "about-us", "Admin\AboutUsController@edit");
		Route::put( "about-us", "Admin\AboutUsController@update")->name('admin.about-us.update');
    ...
    Route::group(['prefix'=>'member','middleware'=>['auth','department']],function(){
        ...
        Route::get("campaigns", "Member\AdvertisementsController@index" );
        Route::get("campaigns/{advertisement:id}/sevaks/create", "Member\AdvertisementsController@create" );
        Route::post("campaigns/{advertisement:id}/sevaks/store", "Member\AdvertisementsController@store" );
        
        Route::get("advertisements", "Member\AdvertisementsController@index" );
        Route::get("advertisements/{advertisement:id}/sevaks/create", "Member\AdvertisementsController@create" );
        Route::post("advertisements/{advertisement:id}/sevaks/store", "Member\AdvertisementsController@store" );
	...
	Route::group(['middleware'=>['auth']],function(){
		Route::get('kyc','Admin\AccountController@kyc')->name('account.kyc');
		Route::post('kyc','Admin\AccountController@saveKyc')->name('account.save-kyc');
    });		
		

	//general auth
    Route::group(['middleware'=>['auth','kyc']],function(){
		...
		Route::get('my-referral','Site\ReferralController@myReferral')->name('site.my-referral');
		
		Route::get("advertisements", "Admin\AdvertisementSevakController@index" );
		Route::get("advertisements/analytics", "Admin\AdvertisementSevakController@analytics" );

    });
    
    Route::get("advertisement/share/{advertisement:ad_id}/{user_id}", "Admin\AdvertisementSevakController@share" );
